const fragmentShaderText04 =`
    ...
    void main(void) {
		...
		vec4 color_m = vec4(0.1,0,8,1);
		
		// Calculate the ambient color as a percentage of the surface color
		ambient_color = u_ambientColor * vec3(color_m);
		...
		diffuse_color = vec3(color_m) * cos_angle;
	    ...
	    //object_color = vec3(color_m) * (1.0 - cos_angle);
